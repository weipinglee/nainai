...
{literal}<script src="images/responsiveslides.min.js"></script>{/literal}
{literal}
	 ...
	 <div class="header-bottom">			
			 ...
			 <div class="top-nav">
				<ul class="memenu skyblue">
					...
					<li {if $nav.cur} class="grid" {/if}><a href="{$nav.url}"{if $smarty.foreach.nav_middle_list.iteration eq 7}{/if}{if $nav.target} target="_blank"{/if}>{$nav.nav_name}</a>
					<!-- {if $nav.child} -->
			 ...
			 <div class="cart box_1">
				<form action="{$site.root_url}" method="get" class="search" id="search" name="search">
					<div class="kuan"><input name="s" type="text" class="keyword" title="{$lang.search_product_cue}" autocomplete="off" maxlength="128" value="{if $keyword}{$keyword|escape}{else}{$lang.search_product}{/if}" onclick="formClick(this,'{$lang.search_product}')"/></div><!--搜索框-->
